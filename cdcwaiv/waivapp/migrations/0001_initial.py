# Generated by Django 5.0.14 on 2025-06-05 19:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('csulb_id', models.CharField(help_text='Raw Participant_ID from Simplicity (no FK lookup).', max_length=20)),
                ...
                ('staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='checkin_counselor', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csulb_id', models.OneToOneField(db_column='csulb_id', on_delete=django.db.models.deletion.CASCADE, related_name='academic_log', to='waivapp.studentpersonalinfo')),
            ],
        ),
        migrations.CreateModel(
            name='CounselingLog',
